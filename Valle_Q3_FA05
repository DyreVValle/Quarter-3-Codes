...
#steps per day
me_steps_numeric = me_steps[1:].astype(int)
lia_steps_numeric = lia_steps[1:].astype(int)
jake_steps_numeric = jake_steps[1:].astype(int)

daily_totals = me_steps_numeric + lia_steps_numeric + jake_steps_numeric
print(f"\nTotal steps per day:")
